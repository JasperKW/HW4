...
def your_config():
    ...
    config = {
        ...
        'top_k': 15,         # Reduced to ensure the model focuses on the top probable choices
        'top_p': 0.5,        # Slightly reduced to narrow down the sampling set
        'repetition_penalty': 1.2,  # Increased to penalize repetitive outputs and encourage correct results
        'stop': []
    }
